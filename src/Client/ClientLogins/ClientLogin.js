...
const ClientLogin = () => {
  ...
  const handleClick = async () => {
    ...
    if (data.user.role !== "client") {
      setErrorMessage("Access denied. Only Clients can log in to this section.");
      return;
    }
      ...
      localStorage.setItem("home-ownerFirstName", data.user.firstName);
      localStorage.setItem("home-ownerLastName", data.user.lastName);
      localStorage.setItem("home-ownerEmail", data.user.email);
      localStorage.setItem("home-ownerRole", data.user.role);
      localStorage.setItem("home-ownerType", data.user.type);
