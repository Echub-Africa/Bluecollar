            ...
            {activeLink === "details" && (
              <div className="left-body">
                <div className="left-body-1">
                    ...
                    <div className="service-1">
                        <h6>Location</h6>
                        <p>284 Allen Avenue Ikeja, Lagos</p>
                    </div>
                    <div className="service-1">
                        <h6>File Upload</h6>
                        <p>None</p>
                ...
                <div className="left-body-2">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur. Sed in gravida a platea lectus. Aenean facilisi id sit porta vestibulum bibendum interdum dolor. Nec mi interdum euismod at aliquam amet donec. Laoreet morbi arcu pellentesque malesuada. Odio quam imperdiet dignissim mi cursus eu venenatis. Tortor sed nibh enim rutrum. Dis tellus aliquam lacinia amet urna posuere. Gravida consectetur etiam amet 
                        maecenas quam.</p>
