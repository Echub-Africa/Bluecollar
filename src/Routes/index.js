...
import ForgotPassword from "../Artisan/SignUpPages/Forgotpassword.js";
import ResetPassword from "../Artisan/SignUpPages/resetpassword.js";
...
import Forgotpass from "../company/Forgotpass.js";
import Resetpass from "../company/Resetpass.js";
  ...
  return useRoutes([
...

    {
      ...
      children: [
        ...
        { path: "/artisanAuth/resetPassword", element: <ResetPassword /> },
        { path: "/artisanAuth/signUpArtisan", element: <SignUpArtisan /> },
        {
          path: "/artisanAuth/signUpArtisan/ConfirmEmail",
          element: <ArtisanConfirmEmail />,
        },
        { path: "/artisanAuth/signUpOwner", element: <SignUpOwner /> },
        {
          path: "/artisanAuth/ownerOnboarding",
          element: <SignUpOwnerDetail />,
        },
        { path: "/artisanAuth/login/Artisan", element: <ArtisanLogin /> },
        { path: "/artisanAuth/login", element: <ArtisanPreLogin /> },
        { path: "/artisanAuth/forgotPassword", element: <ForgotPassword /> },
        { path: "/artisanAuth/artisanLog", element: <ArtisanLog /> },
        { path: "/artisanAuth/artisanreg", element: <Artisanreg /> },
      ],
    },

    {
      ...
      children: [
        ...
        { path: "/companyAuth/forgotPassword", element: <Forgotpass /> },
        { path: "/companyAuth/resetPassword", element: <Resetpass /> },
      ],
    },

    {
      ...
      children: [
        ...
        { path: "/clientAuth/resetPasswordd", element: <ResetPasswordd /> },
        { path: "/clientAuth/login", element: <ClientLogin /> },
        { path: "/clientAuth/confirmEmail", element: <ClientConfirmEmail /> },
        { path: "/clientAuth/forgotPasswordd", element: <ForgotPasswordd /> },
      ],
    },

    {
      ...
      children: [{ path: "/adminAuth/Login", element: <AdminLogin /> }],
    },
...

    {
      ...
      children: [
        ...
        {
          path: "/company/request/details/:id",
