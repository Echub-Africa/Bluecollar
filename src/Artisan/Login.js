...
const ArtisanLogin = () => {
  ...
  const handleClick = async () => {
    ...
    if (data.user.role !== "user") {
      setErrorMessage("Access denied. Only Users can log in to this section.");
      return;
    }
      ...
      localStorage.setItem("artisanFirstName", data.user.firstName);
      localStorage.setItem("artisanLastName", data.user.lastName);
      localStorage.setItem("artisanEmail", data.user.email);
      localStorage.setItem("artisanRole", data.user.role);
      localStorage.setItem("artisanType", data.user.type);
