...
const ArtisanConfirmEmail = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const res = await fetch("https://blucolar-be.onrender.com/api/auth/verify", {
        method: "POST",
        headers: {
      ...
      localStorage.setItem("artisanName", data.user?.firstName || "Artisan");

      navigate("/artisanAuth/login");
    } catch (error) {
      alert(error.message);
    } finally {
...
export default ArtisanConfirmEmail;
