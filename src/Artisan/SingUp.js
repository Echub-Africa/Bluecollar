...
const ArtisanSignUp = () => {
  ...
  const handleClick = () => {
    if (activeLink==="artisan") {
        navigate('/artisanAuth/signUpArtisan')
    }
    if (activeLink==="company") {
      navigate('/companyAuth/signUp')
  }
  if (activeLink==="owner") {
    navigate('/clientAuth/signUp')
      ...
      <div className="all-sign">
        <div className="upper-sign">
          <div className="sign-1">
            <h2>Join as a home owner or company</h2>
            <p>Choose your proffered account type</p>
          </div>
          <div className="sign-2">
          
            <div
              onClick={() => handleLinkClick("owner")}
              className={`sub-sign-2 ${activeLink === "owner" ? "active" : ""}`}
            >
              <div
                className={`inner-sign ${
                  activeLink === "owner" ? "active" : ""
                }`}
              >
                <img src="/images/home.png" alt="" />
                <span></span>
              </div>
              <p>I’m home owner, looking for an artisan</p>
            </div>
            <div
            ...
            >
              ...
              <p>We’re a company, that require artisan services</p>
            </div>
          </div>
