...
const AdminLogin = () => {
  ...
  const handleClick = async () => {
    ...
    if (data.user.role !== "admin") {
      setErrorMessage("Access denied. Only Admins can log in to this section.");
      return;
    }
      ...
      localStorage.setItem("adminType", data.user.type);
    ...
    <LoginRap>
      <div className="all-sign">
        <div className="login-all">
          ...
          >
           {isSubmitting ? "Logging in as Admin..." : "Login"}
          </button>
