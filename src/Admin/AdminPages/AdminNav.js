...
const AdminDashboardNavbar = () => {
  ...
  useEffect(() => {
    ...
    navigate("/adminAuth/Login"); // Or your landing page route
  };
                ...
                {optionDrop ? (
                  <>
                    <div className="optionpop">
                      <Link onClick={handleOptionDrop} to="/admin/settings" className="optionpop-btn">
